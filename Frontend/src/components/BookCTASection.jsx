...
const contactCards = [
    {
        ...
        description:
            "Book a discovery call and we can go through your goals, current situation, and the best next step clearly.",
    ...
    },
    {
        ...
        description:
            "Message me if you want a faster conversation without the back and forth of email.",
    ...
    {
        label: "Digital Card",
        title: "Save my details for later",
        description:
            ...
            <div className="bookcta__inner">
                            ...
                            <div className="bookcta__profile-details">
                                <div className="bookcta__profile-content">
                                    ...
                                    <p className="bookcta__profile-role">
                                        UI/UX Focused Full Stack Designer &amp;
                                        Developer
                                    </p>
                                </div>
                                ...
                                <div className="bookcta__quick-list">
                                    <div className="bookcta__quick-item">
                                        <span className="bookcta__quick-key">
                                            Email
                                        </span>
                                        <a
                                            href="mailto:hello@konardesign.com"
                ...
                <div className="bookcta__social">
                    <div className="bookcta__social-copy">
                        <h3 className="bookcta__social-title">
                            Social Channels
                        </h3>
                        <p className="bookcta__social-subtitle">
                            Follow along, connect properly, or keep my details
                            close for when the timing is right.
                        </p>
                    </div>
